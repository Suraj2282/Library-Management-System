...
import com.cts.liveproject.librarymanagementsystem.excpetion.UserNotFoundException;
...
//			adminAccount.setUserId(userId);
			...
			adminAccount.setUserRole(UserRoles.ADMIN);
	...
	public User getAdminName(Long id) {
		return userRepository.findById(id).orElseThrow(()->new UserNotFoundException("User not found for Id Provided :"+id));
	}
