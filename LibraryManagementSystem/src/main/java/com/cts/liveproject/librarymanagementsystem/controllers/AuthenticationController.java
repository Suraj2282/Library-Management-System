...
public class AuthenticationController {
	...
	public void createAuthentiationToken(@RequestBody AuthenticationRequest authenticationRequest, HttpServletResponse response) throws IOException, JSONException
	{
		try
		{
